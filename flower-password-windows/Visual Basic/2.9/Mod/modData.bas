...
Private Function FormatPath(ByVal strPath As String) As String
...
Private Function LoadDomains() As Boolean
    ...
    strPath = SaveFilePath("Domains.tmp")
...
Private Function SaveFilePath(ByVal strFileName As String) As String

    Dim tempPath As String

    tempPath = GetTempPathByApi

    If tempPath <> vbNullString Then
        SaveFilePath = FormatPath(tempPath) + strFileName
    Else
        SaveFilePath = FormatPath(App.Path) + strFileName
