...
Public Function calcFlowerPassword(ByVal strPassword As String, _
    ...
    If Len(strPassword) > 0 And Len(strKey) > 0 Then
        ...
        If IsNumeric(code1) Then
            ...
            code16 = "K" + Mid$(code32, 2, PasswordBit - 1)
        Else
            'code16 = Left$(code32, 16)
            code16 = Left$(code32, PasswordBit)

        End If

        calcFlowerPassword = code16
        'If PasswordBit = 16 Then
        'calcFlowerPassword = code16
        'Else
        'calcFlowerPassword = code32
        'End If
        Set cMD5 = Nothing
