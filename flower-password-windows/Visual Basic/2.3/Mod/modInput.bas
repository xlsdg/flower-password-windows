...
Public Function PostCode(ByVal strCode As String, _
                         Optional ByVal TextBoxHwnd As Long = 0) As Long

    If PostCodeToIE(strCode) > 0 Then
        PostCode = 1
    ElseIf TextBoxHwnd > 0 Then
...
Private Function PoseCodeByHardwareDriver(ByVal WinHwnd As Long, _
                                          ByVal strCode As String) As Long
