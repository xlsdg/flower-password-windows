...
Private Function PoseCodeByHardwareDriver(ByVal strCode As String) As Long
...
Private Function PoseCodeByWinIO(ByVal strCode As String, Optional ByVal useWinIO As Boolean = False) As Long
    Sleep 750
    If useWinIO Then
        PoseCodeByHardwareDriver strCode
    Else
        PoseCodeBySendInput strCode
    End If
